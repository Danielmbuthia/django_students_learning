# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-04-17 09:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ManyToManyField(to='somoapp.Book')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.IntegerField()),
                ('unit', models.CharField(max_length=80)),
                ('course', models.ManyToManyField(to='somoapp.Course')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_id', models.ManyToManyField(to='somoapp.Course')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='book',
            name='course',
            field=models.ManyToManyField(to='somoapp.Course'),
        ),
        migrations.AddField(
            model_name='book',
            name='user',
